...
public:
  ...
  /// This function inserts all of the characters in s into the stored string
  ...
  /// because the caller need not know any details (like special arguments)
  /// about the object(s) created by the Factory Method.
